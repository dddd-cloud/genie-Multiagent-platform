...
@RestControllerAdvice(basePackages = "com.jd.genie.platform.phase2.configuration.team.api")
public class TeamApiExceptionHandler {

    @ExceptionHandler(TeamConfigurationException.class)
    ResponseEntity<ApiResponse<Void>> team(TeamConfigurationException exception) {
