...
class McpToolInputValidationTest {
    ...
    @Test void argumentLimitIsEnforced() {
        ...
        var adapter = new UserMcpToolAdapter(jdbc, mock(McpClientAdapter.class), mock(CredentialEnvelopeService.class), mock(McpUrlPolicy.class), mapper, new CurrentUser("t", "o", "u", "U", null), "tool", "server", "mcp:tool", "mcp_tool", "remote_tool", "d", mapper.createObjectNode());
