...
class DirectPlanSolveAdapterTest {

    @Test
    void directPlanSolveUsesExistingAutoAgentEndpointWithRuntimeSopPromptOnly() throws Exception {
        ...
        request.setRuntimeBasePrompt("must-not-reach-plan-solve");
        ...
        assertEquals("", internal.getBasePrompt());
        assertEquals("[UNTRUSTED_LOCAL_CONTEXT] plan context", internal.getSopPrompt());
    }
