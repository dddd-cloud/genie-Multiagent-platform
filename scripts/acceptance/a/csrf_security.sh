...
command_name="mvn -q -Dtest=SecurityCsrfIntegrationTest test"
...
if (cd genie-backend && mvn -q -Dtest=SecurityCsrfIntegrationTest test) >/dev/null 2>&1; then finish 0 "PASS"; fi
finish 1 "FAIL"
