...
class DeepSearch:
    ...
    def __init__(self, engines: List[str] = []):
        ...
        use_ddg = "ddg" in engines or "duckduckgo" in engines
        self._search_single_query = partial(
            MixSearch().search_and_dedup, use_bing=use_bing, use_jina=use_jina, use_sogou=use_sogou, use_serp=use_serp, use_ddg=use_ddg)
